...
RUN echo 'export PATH=${FLUTTER_HOME}/bin:${FLUTTER_HOME}/bin/cache/dart-sdk/bin:${PUB_CACHE}/bin:${FLUTTER_HOME}/.pub-cache/bin:$HOME/flutter/.pub-cache/bin:${ANDROID_HOME}/tools:${ANDROID_HOME}/platform-tools:$PATH' >> ~/.bashrc
